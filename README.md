...
In the Manifest file, specify buildpack: https://github.com/???.git#<BRANCH> eg v4.9-appd_ver4.3.7.2 
OR pass in buildpack information with 
```
cf push -f manifest.yml -b github.com/???.git#<BRANCH> eg v4.9-appd_ver4.3.7.2
```
